...
import 'package:aiapp/remindersFlow1/done.dart';
...
class ReminderFlowOneSet extends StatefulWidget {
  final index;
  ReminderFlowOneSet({Key key, @required this.index}) : super(key: key);

  @override
  _ReminderFlowOneSetState createState() => _ReminderFlowOneSetState();
}

class _ReminderFlowOneSetState extends State<ReminderFlowOneSet> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                'Set your "$reminderName" reminder.',
                style: TextStyle(
                  fontFamily:'OpenSans',
