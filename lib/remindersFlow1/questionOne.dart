...
class QuestionOne extends StatelessWidget {
  ...
  final index;
  QuestionOne({Key key, @required this.index}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                meReminders.getReminders[index][5],
                  ...
                  onPressed: () => {
                    ...
                    Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: QuestionThree(index:index),
                      ),
                    )
                  },
